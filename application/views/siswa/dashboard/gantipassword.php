                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-inverse">
                            ...
                            <form class="form-horizontal form-group row-sm"  action="<?=base_url($link)?>" method="POST">
                    ...
                    <input type="password" name="pass2" value="" placeholder="Konfirmasi Password Baru"  class="form-control" required>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      ...
                                      <button type="submit" id="btnSimpan" name="simpan" class="btn btn-success">Simpan</button>
                                      <a href="<?=base_url('siswa')?>" class="btn btn-danger">Cancel</a>
                                    </div>
                                  </div><!-- row -->
