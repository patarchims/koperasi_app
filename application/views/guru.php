      ...
      <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown navbar-user">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a href="<?=base_url('guru/profil')?>" class="dropdown-item">Profile</a>
            <a href="<?=base_url('guru/gantipassword')?>" class="dropdown-item">Ubah Password</a>
        ...
        <ul class="nav">
          ...
          <li>
            <ul class="nav nav-profile">
              <li><a href="<?=base_url('guru/profil')?>"><i class="fa fa-user"></i> Profil</a></li>
              <li><a href="<?=base_url('guru/gantipassword')?>"><i class="fa fa-key"></i> Ubah Password</a></li>
