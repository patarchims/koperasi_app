  ...
  <div class="panel-body">
    <form class="form-horizontal" onsubmit="ShowLoading()" action="<?= current_url() ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?= formInputText('judul_surat', 'SURAT REKOMENDASI', 'Judul Surat', 'required') ?>
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?= formInputText('pengantar', '', 'Pengantar', 'required') ?>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?= formInputText('nisn', '', 'NISN', 'required') ?>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?= formInputText('sekolah_asal', '', 'Sekolah Asal', 'required') ?>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?= formInputText('nama_ortu', '', 'Nama Orang Tua', '') ?>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?= formInputTextarea('keterangan', '', 'form-control', 'Keterangan Rekomendasi') ?>
        </div>
      </div>
