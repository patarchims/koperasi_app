            ...
            <tbody>
              ...
              foreach ($record as $row) {
                echo '<tr>
                            ...
                            <td>' . stripslashes($row['pangkat']) . '</td>
                            <td>' . stripslashes($row['jabatan']) . '</td>
                            <td>' . stripslashes($row['kategori']) . '</td> 
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Form Tambah Penandatangan</h4>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <select class="form-control" name="kategori" required>
                <?= opEnum('layanan_penandatangan', 'kategori', '') ?>
              </select>
            </div>
          </div>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Form Edit Penandatangan</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span></button>
      </div>
      <form class="form-horizontal" action="<?= current_url() ?>" enctype="multipart/form-data" method="POST">
