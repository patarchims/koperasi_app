  ...
  <div class="panel-body">
    <form class="form-horizontal" onsubmit="ShowLoading()" action="<?= current_url() ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?= formInputText('isi1', stripslashes($rows['isi1']), 'Isi', 'required') ?>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?= formInputText('judul_penelitian', stripslashes($rows['judul_penelitian']), 'Judul Penelitian', 'required') ?>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?= formInputText('isi2', stripslashes($rows['isi2']), 'Isi', 'required') ?>
        </div>
      </div>
