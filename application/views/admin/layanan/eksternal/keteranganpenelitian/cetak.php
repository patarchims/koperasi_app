...
$table->printRow();
$table->easyCell(stripslashes($rows['judul_surat']), "align:C; font-style:BU; font-size:12; valign:B;  colspan:6; padingY:0; ");
$table->printRow();
...
$table->endTable();
$pdf->RowNoLine(array(stripslashes($rows['isi1'])));
$pdf->Ln(2);
$pdf->SetFont('Arial', 'B', 11);
$pdf->RowNoLine(array(chr(147) . stripslashes($rows['judul_penelitian']) . chr(148)));
$pdf->Ln(2);
$pdf->SetFont('Arial', '', 11);
$pdf->RowNoLine(array(stripslashes($rows['isi2'])));
$pdf->Ln(4);
