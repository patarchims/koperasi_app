...
$table->printRow();
$table->easyCell("", "align:L; font-size:11; ");
$table->easyCell("Pangkat/Gol", "align:L; font-size:11; colspan:2;");
$table->easyCell(": " . stripslashes($rows['ppangkat']), "align:L; font-size:11; colspan:3; ");
$table->printRow();
$table->easyCell("", "align:L; font-size:11; ");
...
$table->easyCell("", "align:L; font-size:11; ");
$table->easyCell("Pangkat/Gol", "align:L; font-size:11; colspan:2;");
$table->easyCell(": " . stripslashes($rows['pangkat'] . '/' . $rows['gol']), "align:L; font-size:11; colspan:3; ");
$table->printRow();
$table->easyCell("", "align:L; font-size:11; ");
$table->easyCell("Jabatan", "align:L; font-size:11; colspan:2;");
$table->easyCell(": " . stripslashes($rows['pjabatan']), "align:L; font-size:11; colspan:3; ");
...
$pdf->Ln(5);
$pdf->RowNoLine(array("Demikian kami sampaikan, atas perhatiannya kami ucapkan terima kasih."));
$pdf->Ln(10);
...
$table->printRow();
$table->endTable();
$pdf->SetTitle("SuratKeterangan" . time());
$pdf->Output();
