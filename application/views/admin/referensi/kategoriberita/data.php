                ...
                <?php 
                  $no = 1;
                    ...
                    echo '<tr>
                            ...
                            {
                              echo aksiModalEdit('#modalEdit',$row['id_kategori']);
                            }
                            echo '&nbsp;';
                            if(bisaHapus($link,$id_level))
                            {
                              echo aksiHapus($link.'hapus',enkrip($row['id_kategori']));
                            }
                          echo '</td>
  ...
  <div class="modal-dialog modal-md">
      <div class="modal-content">
          <div class="modal-header">
              ...
              <h4 class="modal-title">Form Tambah Kategori Berita</h4>
          ...
          <div class="modal-body">
            ...
            <div class="form-group row">
                <label class="control-label col-sm-3">Nama Kategori Berita</label>
                <div class="col-sm-9">
                <input type="text" class="form-control" name="kategori" value="" placeholder="" >
                </div>
              </div>
              <div class="form-group row">
...
<script  type="text/javascript">
  $(document).ready(function(){
    $('#modalEdit').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'POST',
                url : '<?=base_url('referensi/kategoriedit')?>',
                data :  'rowid='+ rowid,
