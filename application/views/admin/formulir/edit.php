            ...
            <div class="card card-primary">
              ...
              <form class="form-horizontal" onsubmit="ShowLoading()" action="<?= base_url($link . 'edit') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="card-body">
                  ...
                  <input type="hidden" name="id" value="<?= $rows['id_anggota'] ?>">
                  ...
                  <div class="form-group ">
                    ...
                    <select name="jenis_kelamin" class="form-control" required>
                      <?= opKodeApp('KELAMIN', $rows['jenis_kelamin']) ?>
                    </select>
                  </div>

                  <div class="form-group">
                    <label class="control-label">Tempat Lahir</label>
                    <?= formInputText('tempat_lahir', $rows['tempat_lahir'], 'Tempat Lahir', 'required') ?>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <?= formInputText('alamat', $rows['alamat'], 'Alamat', 'required') ?>
                    </div>

                    <div class="form-group">
                      <label class="control-label">Pekerjaan</label>
                      <?= formInputText('pekerjaan', $rows['pekerjaan'], 'Pekerjaan', 'required') ?>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <?= formInputText('email', $rows['email'], 'Email', 'required') ?>
                    </div>

                    <div class="form-group">
                      <label class="control-label">Telp</label>
                      <?= formInputNumber('telp', $rows['telp'], 'Telp', 'required') ?>
                    </div>

                    <div class="form-group">
                      <label class="control-label">No Identitas</label>
                      <?= formInputNumber('no_identitas', $rows['no_identitas'], 'No Identitas', 'required') ?>
                    </div>


                    <div class="form-group">
                      <label class="control-label ">Tanggal Daftar</label>
                      <?= formInputDate('tgl_daftar', $rows['tgl_daftar'], 'Tanggal Daftar', '') ?>
                    </div>
