            ...
            <div class="panel-body bg-silver">
                <div class="chats">
                    ...
                    foreach ($chat as $row) {
                        ...
                        if ($row['pengirim'] == 'Guru') {
                            echo '<div class="left">
                                    <span class="date-time">' . tgl_waktu_full($row['create_at']) . '</span>
                                    <a href="javascript:;" class="name">' . stripslashes(viewGuru($row['id_pengirim'], 'nama')) . '</a>
                                    <a href="javascript:;" class="image"><img alt="" src="' . gambarAws(viewGuru($row['id_pengirim'], 'gambar')) . '" width="75"/></a>
                                    <div class="message">
