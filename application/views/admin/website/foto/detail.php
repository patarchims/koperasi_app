      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group row">
                <label class="control-label col-sm-3">Judul Foto</label>
                <div class="col-sm-9">
                <?=formInputText('judul','','Judul Foto','required')?>
                </div>
              </div>
              <div class="form-group row">
...
<script>
  ...
  $(document).ready(function(){
    ...
    table = $('#mytable').DataTable({ 
            ...
            "ajax": {
                "url": "<?php echo base_url('website/get_foto/'.$id_album)?>",
                "type": "POST"
            },
