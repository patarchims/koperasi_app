  ...
  <div class="panel-body">
    <form class="form-horizontal" onsubmit="ShowLoading()" action="<?=base_url($link.'edit')?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?=formInputText('judul',stripcslashes($rows['judul']),'Judul Pengumuman','required')?>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          <?=formInputDate('tanggal',$rows['tanggal'],'Tanggal Pengumuman','required')?>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          ...
          {
            echo aksiModalLihat('#modalFile',$rows['id_pengumuman'],'Lihat');
          }
          ?>
        </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-10">
          ...
          <small>Kosongkan Jika Tidak Memerlukan/Mengganti File</small>
        </div>
      </div>
...
<script>
  ...
  $(document).ready(function(){
     ...
     $('#modalFile').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'POST',
                url : '<?=base_url('website/pengumumanfile')?>',
                data :  'rowid='+ rowid,
